  ...
  return (
    <div className="flex flex-col w-full h-full bg-[#f4f5f7]">
      ...
      <main className="flex-1 overflow-y-auto hide-scrollbar p-6">
        <div className="max-w-[1400px] mx-auto w-full flex flex-col h-full">
          ...
          <div className="flex justify-between items-center mb-6 animate-fade-in-up">
            ...
            <div className="flex items-center gap-3">
              <button className="w-10 h-10 flex items-center justify-center bg-white rounded-full border border-slate-200 transition-all text-slate-600 hover:text-black shadow-sm">
                <Settings2 className="w-4 h-4" />
              </button>
              
              <button className="px-4 h-10 flex items-center gap-2 bg-black text-white rounded-full hover:bg-slate-800 transition-all text-xs font-semibold shadow-sm">
                <Calendar className="w-3.5 h-3.5 text-slate-400" />
                <span>22 Jun 2026 - 26 Jun 2026</span>
              </button>

              <button className="hidden sm:flex px-4 h-10 items-center gap-2 bg-white rounded-full border border-slate-200 transition-all text-xs font-semibold shadow-sm">
        ...
        <div className="col-span-1 md:col-span-1 lg:col-span-1 bg-white rounded-[2rem] p-6  flex flex-col h-[400px] relative overflow-hidden group">
        ...
        <div className="col-span-1 md:col-span-2 lg:col-span-2 flex flex-col gap-6">
          <div className="bg-white rounded-[2rem] p-6  h-[190px] flex flex-col relative">
          ...
          <div className="bg-white rounded-[2rem] p-6  h-[186px] relative overflow-hidden flex flex-col">
            ...
            <div className="space-y-4">
              {[1, 2, 3].map((i) => (
                <div key={i} className="flex items-center gap-4">
                  ...
                  <div className="text-sm font-semibold">${(i * 3.5).toFixed(1)}k</div>
                </div>
              ))}
            </div>
          </div>
