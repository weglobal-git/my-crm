          ...
          <div className="bg-[#3A3B3C] border border-[#4E4F50] rounded-[2rem] p-6 h-[190px] flex flex-col relative">
            <div className="flex justify-between items-start mb-4">
              <div>
                ...
                <p className="text-xs text-slate-400 mt-1">From active deals</p>
              </div>
              ...
              {[1, 2, 3].map((i) => (
                <div key={i} className="flex items-center gap-4">
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="font-medium text-xs text-slate-100 truncate">QT-2026-{240+i}</div>
                    <div className="text-xs text-slate-400">To: TechCorp Inc.</div>
                  </div>
                  <div className="text-xs font-semibold text-slate-100">${(i * 3.5).toFixed(1)}k</div>
                </div>
              ))}
            </div>
          </div>
