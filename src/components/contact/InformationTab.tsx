      ...
      {!showLogTab ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="flex flex-col gap-1.5">
                ...
                <div className="bg-[#252728] rounded-xl px-3 py-2 text-xs text-slate-300 border-0 flex items-center gap-2">
                  ...
                  <span className="text-xs text-slate-500 font-normal ml-auto">From Account</span>
                </div>
              </div>
              ...
              <div className="flex flex-col gap-1.5 md:col-span-2">
                <div className="flex items-center justify-between">
                  ...
                  <button
                    ...
                    className="text-xs font-semibold text-[#C7F33C] hover:underline flex items-center gap-1"
                  >
                    + Add Email
                  </button>
                </div>
        ...
        <div className="flex flex-col gap-4">
          <div className="flex items-center justify-between text-xs text-slate-400 mb-1">
            ...
            <span className="px-2 py-0.5 rounded-full bg-[#252728] text-xs font-semibold">
