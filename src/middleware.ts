...
export default withAuth(
  function middleware(req) {
    ...
    const isCrmPage = path.startsWith("/pipeline") || path.startsWith("/quotations") || path.startsWith("/contact") || path.startsWith("/customers") || path.startsWith("/sale") || path.startsWith("/marketing") || path.startsWith("/maintenance") || path.startsWith("/calendar");
    if (isCrmPage) {
